...
import type { User } from '@/app/(payload)/payload-types'
import { UserCart } from 'types'
import { saveCartToStorage } from '../utilities/cartLocalStorage'
...
type AuthContext = {
  ...
  setCart: (cart: UserCart) => void // eslint-disable-line no-unused-vars
